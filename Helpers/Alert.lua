...
local fullTitle = "Welcome to Evelynn Hub!"
task.spawn(function()
...
info.ZIndex = 11
info.Text = "Scripts may take a while to load due to the complexity in obfuscation.\nJoin out discord for key updates and alerts.\nThanks for using!"
